...
export const MatchingEditing = ({ question, onChange }: MatchingEditingProps) => {
  ...
  const removePair = (pairId: string) => {
    if (question.data.pairs.length <= 2) {
      alert('At least 2 pairs required');
      return;
    }
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold">Matching</h3>
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <Label className="text-xs font-medium text-gray-700 dark:text-gray-300">Matching Pairs</Label>
          {/* Shuffle Pairs */}
          <div className="flex items-center gap-2">
            <Shuffle className="h-3.5 w-3.5 text-gray-500" />
            <Label className="text-xs font-medium text-gray-600 dark:text-gray-400">Shuffle Pairs</Label>
            <Switch
