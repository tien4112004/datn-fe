...
import { useGenerateQuestionsFromContext } from '@/features/assignment/hooks/useGenerationApi';
import type { GenerateQuestionsFromContextRequest } from '@/features/assignment/types/generation';
