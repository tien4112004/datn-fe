...
export const MatchingAfterAssessment = ({ question, answer }: MatchingAfterAssessmentProps) => {
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <p className="text-muted-foreground text-sm">
          {correctCount} out of {totalCount} pairs correct • Score: {score}/{question.points || 0}
        </p>
      </CardContent>
    </Card>
  );
