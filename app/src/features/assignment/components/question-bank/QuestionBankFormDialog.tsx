...
export function QuestionBankFormDialog({ open, onClose, mode, question }: QuestionBankFormDialogProps) {
  ...
  return (
    <Dialog open={open && !!questionData} onOpenChange={onClose}>
        ...
        {questionData && (
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-muted/10 space-y-4 rounded-lg border p-4">
              <h3 className="text-sm font-medium">Question Metadata</h3>
            ...
            <div className="mt-6">
              <h3 className="mb-4 text-sm font-medium">Question Content</h3>
