...
import { Brain, FileText, GitBranch, HelpCircle, Sparkles, Users } from 'lucide-react';
...
export function AuthHero() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Panels scatter in — each unique entry angle, big back.out bounce
      tl.to(
        panelPresRef.current,
  ...
  return (
    ...
    >
      ...
      >
        {/* Row 1 — pres left-of-centre, mindmap right-leaning */}
        <div className="flex w-full items-end justify-center gap-5">
          ...
          >
            ...
            <div className="space-y-1.5">
              ...
              <div ref={s2}>
                <SlideCard title={t('login.heroSlide2')} lines={[80, 60, 70]} />
              </div>
              <div ref={s3}>
