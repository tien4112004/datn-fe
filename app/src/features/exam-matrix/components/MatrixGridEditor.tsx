...
import type { MatrixCell, Topic, TopicId } from '@/features/exam-matrix/types';
...
export const MatrixGridEditor = ({ open, onClose }: MatrixGridEditorProps) => {
  ...
  const { currentMatrix, updateCell, removeCell, getCellByTopicAndDifficulty } = useExamMatrixStore();
