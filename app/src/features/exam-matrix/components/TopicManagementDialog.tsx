...
import { useTopicsBySubject } from '@/features/exam-matrix/hooks/useExamMatrixApi';
import type { Topic } from '@/features/exam-matrix/types';
...
export const TopicManagementDialog = ({ open, onClose }: TopicManagementDialogProps) => {
  ...
  const { currentMatrix, addTopic, removeTopic } = useExamMatrixStore();
