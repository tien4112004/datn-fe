export default {
  ...
  teacherQuestionBank: {
    ...
    dialogs: {
      ...
      import: {
        ...
        validation: {
          noQuestions: 'No valid questions found in CSV',
          titleRequired: 'Title is required',
          titleTooLong: 'Title is very long (>500 chars)',
          typeRequired: 'Question type is required',
          invalidType: 'Invalid question type: {{value}}',
          difficultyRequired: 'Difficulty is required',
          invalidDifficulty: 'Invalid difficulty: {{value}}',
          subjectRequired: 'Subject is required',
          invalidSubject: 'Invalid subject: {{value}}',
          unknownGrade: 'Unknown grade: {{value}}. Expected 1-5.',
          minOptions: 'At least 2 options are required',
          tooManyOptions: 'More than 6 options may be confusing',
          noCorrectOption: 'At least one correct option is required',
          multipleCorrectOptions: 'Multiple correct options found (multi-select)',
          optionTextRequired: 'Option {{index}} text is required',
          minPairs: 'At least 2 matching pairs are required',
          tooManyPairs: 'More than 10 pairs may be difficult to match',
          pairLeftRequired: 'Pair {{index}} left side is required',
          pairRightRequired: 'Pair {{index}} right side is required',
          maxLengthTooShort: 'Max length is very short (<10 chars)',
          maxLengthTooLong: 'Max length is very long (>5000 chars)',
          expectedAnswerRecommended: 'Expected answer is recommended for grading reference',
          segmentsRequired: 'Question segments are required',
          blankPlaceholderRequired: 'At least one {blank} placeholder is required',
          tooManyBlanks: 'More than 10 blanks may be confusing',
          blankAnswerRequired: 'Blank {{index}} answer is required',
        },
      },
      export: {
  ...
  submissions: {
    ...
    assignmentSubmissions: {
      ...
      notAvailable: 'N/A',
      waitingForReview: 'students waiting for review',
      noSubmissions: 'No submissions yet',
