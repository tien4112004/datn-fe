  ...
  teacherQuestionBank: {
    ...
    dialogs: {
      ...
      import: {
        ...
        titleResult: 'Import Result',
        descriptionUpload: 'Upload a CSV file to preview questions before importing.',
        descriptionPreview: '{{count}} question(s) found. Review and select the ones you want to import.',
        descriptionResult: 'Import has completed.',
        ...
        formatRules: {
          ...
          optional: 'Optional fields: grade, chapter, explanation',
          typeSpecific: 'Type-specific fields vary (options for multiple choice, pairs for matching, etc.)',
          templateHint: 'Use "Template" button to download examples for each question type',
        },
        validationErrors: '{{count}} validation error(s) found — please fix and re-upload.',
        validationWarnings: '{{count}} warning(s) — you can still import.',
        moreErrors: '... and {{count}} more error(s)',
        moreWarnings: '... and {{count}} more warning(s)',
        errorDetails: 'Error Details:',
        moreDetailErrors: '... and {{count}} more errors',
        ...
        errorBadge: '{{count}} error(s)',
        warningBadge: '{{count}} warning(s)',
        cancel: 'Cancel',
        close: 'Close',
        importing: 'Importing...',
        importButton: 'Import {{count}} Question(s)',
