export default {
  ...
  csvImport: {
    ...
    requirements: {
      ...
      columnGender: 'Gender',
      columnGenderDescription: "Student's gender. Accepted values: male, female, other.",
      columnAddress: 'Address',
      columnAddressDescription: "Student's home address.",
      columnParentEmail: 'Parent/Guardian email',
      columnParentEmailDescription: 'Email address of parent or guardian. Format: name@domain.com',
      columnAdditionalNotes: 'Additional notes',
      ...
      fullNameVariations: 'Full Name: fullName, full_name, name, studentName',
      dateOfBirthVariations: 'Date of birth: dateOfBirth, date_of_birth, dob, birthdate',
      genderVariations: 'Gender: gender, sex',
      addressVariations: 'Address: address, homeaddress, home_address',
      parentNameVariations: 'Parent name: parentName, parent_name, guardianName, parentGuardianName',
      parentPhoneVariations: 'Parent phone: parentPhone, parent_phone, parentContactPhone',
      parentEmailVariations: 'Parent email: parentContactEmail, parentEmail, parent_email, guardianEmail',
      additionalNotesVariations: 'Additional notes: additionalNotes, notes, comments, remarks',
