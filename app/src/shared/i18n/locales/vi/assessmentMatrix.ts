export default {
  title: 'Quản lý Ma trận đề',
  subtitle: 'Tạo và quản lý đặc tả đề (Bảng hai chiều)',
  ...
  builder: {
    ...
    createTitle: 'Tạo ma trận đề',
    editTitle: 'Chỉnh sửa ma trận đề',
    tabs: {
  ...
  topic: {
    ...
    dialogSubtitle: 'Thêm chủ đề để xác định cấu trúc ma trận đề',
  ...
  generator: {
    ...
    subtitle: 'Chọn câu hỏi phù hợp với yêu cầu ma trận để tạo đề',
    cellStatus: 'Yêu cầu ô',
    questionBank: 'Ngân hàng câu hỏi',
    generateButton: 'Tạo đề',
    cancelButton: 'Hủy',
    success: 'đề đã được tạo thành công',
  ...
  emptyState: 'Không tìm thấy ma trận đề nào. Tạo ma trận đầu tiên để bắt đầu.',
  ...
  emptyStates: {
    ...
    createFirstMatrix: 'Tạo ma trận đề đầu tiên để bắt đầu',
  },
  ...
  toasts: {
    ...
    matrixNotFound: 'Không tìm thấy ma trận',
    examGenerated: 'đề đã được tạo: {{name}}',
  },
