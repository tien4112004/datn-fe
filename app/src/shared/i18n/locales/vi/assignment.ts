export default {
  ...
  assignmentEditor: {
    ...
    generateByTopic: {
      ...
      errors: {
        ...
        missingMetadata: 'Vui lòng thiết lập khối lớp và môn học trước khi tạo câu hỏi.',
  ...
  teacherQuestionBank: {
    ...
    dialogs: {
      ...
      import: {
        ...
        titleResult: 'Kết quả nhập',
        descriptionUpload: 'Tải lên tệp CSV để xem trước câu hỏi trước khi nhập.',
        descriptionPreview: 'Tìm thấy {{count}} câu hỏi. Xem lại và chọn những câu bạn muốn nhập.',
        descriptionResult: 'Quá trình nhập đã hoàn tất.',
        uploadText: 'Nhấp để tải lên hoặc kéo thả',
        uploadHint: 'Chỉ tệp CSV',
        changeFile: 'Đổi',
        template: 'Mẫu',
        formatTitle: 'Yêu cầu định dạng CSV:',
        formatRules: {
          headers: 'Hàng đầu tiên phải chứa tiêu đề cột',
          required: 'Trường bắt buộc: title, type, difficulty, subject',
          optional: 'Trường tùy chọn: grade, chapter, explanation',
          typeSpecific:
            'Các trường theo loại câu hỏi khác nhau (options cho trắc nghiệm, pairs cho nối, v.v.)',
          templateHint: 'Nhấn nút "Mẫu" để tải ví dụ cho từng loại câu hỏi',
        },
        validationErrors: 'Tìm thấy {{count}} lỗi xác thực — vui lòng sửa và tải lại.',
        validationWarnings: '{{count}} cảnh báo — bạn vẫn có thể nhập.',
        validationItem: '#{{index}}{{field}}: {{message}}',
        moreErrors: '... và {{count}} lỗi khác',
        moreWarnings: '... và {{count}} cảnh báo khác',
        errorDetails: 'Chi tiết lỗi:',
        errorItem: '#{{index}}: {{message}}',
        moreDetailErrors: '... và {{count}} lỗi khác',
        successMessage: 'Nhập thành công {{count}} câu hỏi',
        errorMessage: 'Nhập hoàn tất với lỗi: {{success}} thành công, {{failed}} thất bại',
        selectedCount: '{{selected}} / {{total}} đã chọn',
        errorBadge: '{{count}} lỗi',
        warningBadge: '{{count}} cảnh báo',
        cancel: 'Hủy',
        close: 'Đóng',
        importing: 'Đang nhập...',
        importButton: 'Nhập {{count}} câu hỏi',
        parseError: 'Không thể phân tích tệp CSV',
        validation: {
          noQuestions: 'Không tìm thấy câu hỏi hợp lệ trong CSV',
          titleRequired: 'Tiêu đề là bắt buộc',
          titleTooLong: 'Tiêu đề quá dài (>500 ký tự)',
          typeRequired: 'Loại câu hỏi là bắt buộc',
          invalidType: 'Loại câu hỏi không hợp lệ: {{value}}',
          difficultyRequired: 'Độ khó là bắt buộc',
          invalidDifficulty: 'Độ khó không hợp lệ: {{value}}',
          subjectRequired: 'Môn học là bắt buộc',
          invalidSubject: 'Môn học không hợp lệ: {{value}}',
          unknownGrade: 'Lớp không xác định: {{value}}. Mong đợi 1-5.',
          minOptions: 'Cần ít nhất 2 lựa chọn',
          tooManyOptions: 'Hơn 6 lựa chọn có thể gây nhầm lẫn',
          noCorrectOption: 'Cần ít nhất một đáp án đúng',
          multipleCorrectOptions: 'Tìm thấy nhiều đáp án đúng (nhiều lựa chọn)',
          optionTextRequired: 'Lựa chọn {{index}} cần có nội dung',
          minPairs: 'Cần ít nhất 2 cặp nối',
          tooManyPairs: 'Hơn 10 cặp nối có thể gây khó khăn',
          pairLeftRequired: 'Cặp {{index}} cần có vế trái',
          pairRightRequired: 'Cặp {{index}} cần có vế phải',
          maxLengthTooShort: 'Độ dài tối đa quá ngắn (<10 ký tự)',
          maxLengthTooLong: 'Độ dài tối đa quá dài (>5000 ký tự)',
          expectedAnswerRecommended: 'Nên có đáp án mẫu để tham khảo chấm điểm',
          segmentsRequired: 'Các phân đoạn câu hỏi là bắt buộc',
          blankPlaceholderRequired: 'Cần ít nhất một chỗ trống {blank}',
          tooManyBlanks: 'Hơn 10 chỗ trống có thể gây nhầm lẫn',
          blankAnswerRequired: 'Chỗ trống {{index}} cần có đáp án',
        },
      },
      export: {
        title: 'Xuất câu hỏi',
        description: '{{count}} câu hỏi có sẵn. Xem lại và chọn những câu bạn muốn xuất.',
        selectedCount: '{{selected}} / {{total}} đã chọn',
        cancel: 'Hủy',
        exportButton: 'Xuất {{count}} câu hỏi',
      },
    },
  ...
  submissions: {
    ...
    studentSubmissions: {
      ...
      tableHeaders: {
        attempt: 'Lần nộp',
        submitted: 'Thời gian nộp',
        status: 'Trạng thái',
        score: 'Điểm',
        graded: 'Thời gian chấm',
        actions: 'Thao tác',
      },
    },
    ...
    assignmentSubmissions: {
      ...
      notAvailable: 'N/A',
      waitingForReview: 'học sinh đang chờ duyệt',
      noSubmissions: 'Chưa có bài nộp',
      ...
      expandAttempts: 'Xem các lần nộp',
      collapseAttempts: 'Ẩn các lần nộp',
