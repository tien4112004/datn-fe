export default {
  login: {
    ...
    heroPromptTopic: 'Chủ đề: Toán học – Lớp 3',
    heroPromptButton: 'Tạo ngay',
    heroFeatureOutline: 'Đề cương',
    heroOutlineChapter1: 'Giới thiệu',
    heroOutlineChapter2: 'Khái niệm chính',
    heroOutlineChapter3: 'Luyện tập & ôn tập',
    heroFeaturePresentation: 'Bài trình chiếu',
    heroFeatureMindmap: 'Sơ đồ tư duy',
    heroFeatureQuiz: 'Bài kiểm tra',
    heroFeatureClassroom: 'Lớp học',
    heroSlide1: 'Giới thiệu',
    heroSlide2: 'Khái niệm chính',
    heroSlide3: 'Bài tập',
    heroNodeRoot: 'Toán',
    heroNodeA: 'Cộng trừ',
    heroNodeB: 'Phân số',
    heroNodeC: 'Hình học',
    heroClass1: 'Toán – Lớp 3A',
    heroClass2: 'Toán – Lớp 3B',
    heroClass3: 'Toán – Lớp 4',
    heroStudents: '{{count}} học sinh',
    heroTagline: 'Lớp học với trí tuệ nhân tạo',
    email: 'Email',
