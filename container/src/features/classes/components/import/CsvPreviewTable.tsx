...
import type { CsvStudentRow } from '@/features/classes/types/csvImport';
            ...
            <thead className="sticky top-0 border-b bg-gray-50">
              <tr>
                ...
                <th className="px-3 py-2 text-left text-xs font-medium uppercase tracking-wider text-gray-500">
                  {t('csvImport.preview.firstName')}
                </th>
                <th className="px-3 py-2 text-left text-xs font-medium uppercase tracking-wider text-gray-500">
                  {t('csvImport.preview.lastName')}
                </th>
                <th className="px-3 py-2 text-left text-xs font-medium uppercase tracking-wider text-gray-500">
                  {t('csvImport.preview.email')}
                </th>
                <th className="px-3 py-2 text-left text-xs font-medium uppercase tracking-wider text-gray-500">
              ...
              {data.map((row) => (
                ...
                >
                  ...
                  <td className="whitespace-nowrap px-3 py-2">
                    <span className={row.firstName ? 'text-gray-900' : 'italic text-red-500'}>
                      {row.firstName || t('csvImport.preview.missing')}
                    </span>
                  </td>
                  <td className="whitespace-nowrap px-3 py-2">
                    <span className={row.lastName ? 'text-gray-900' : 'italic text-red-500'}>
                      {row.lastName || t('csvImport.preview.missing')}
                    </span>
                  </td>
                  <td className="whitespace-nowrap px-3 py-2">
                    <span className={row.email ? 'text-gray-900' : 'italic text-red-500'}>
                      {row.email || t('csvImport.preview.missing')}
                    </span>
                  </td>
