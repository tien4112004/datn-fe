 ...
 * Status Constants
 *
 * Status enums and configuration for classes, students, teachers, and lessons.
 */
...
export const TEACHER_STATUS = {
  active: { code: 'active', name: 'Đang dạy', nameEn: 'Active', color: 'green' },
  inactive: { code: 'inactive', name: 'Tạm nghỉ', nameEn: 'Inactive', color: 'gray' },
  retired: { code: 'retired', name: 'Đã nghỉ hưu', nameEn: 'Retired', color: 'orange' },
} as const;
...
export type TeacherStatusCode = keyof typeof TEACHER_STATUS;
