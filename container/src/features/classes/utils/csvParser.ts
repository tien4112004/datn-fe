...
import type {
  ...
  ImportError,
  ImportWarning,
} from '@/features/classes/types/csvImport';
import {
  REQUIRED_COLUMNS,
  MAX_PREVIEW_ROWS,
  IMPORT_WARNING,
 ...
 * Checks for common email structure but allows special characters for international domains
 */
function isValidEmailFormat(email: string): boolean {
  // Simple regex that allows most international email addresses
