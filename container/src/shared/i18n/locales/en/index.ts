export default {
  ...
  presentation: {
    createOutline: {
      ...
      modelLabel: 'Models',
      languagePlaceholder: 'Which language?',
      ...
      targetAgePlaceholder: 'For which age group?',
      targetAgeLabel: 'Target Age',
      targetAgePreschool: 'Preschool (3-5)',
      targetAgeEarlyElementary: 'Early Elementary (5-7)',
      targetAgeElementary: 'Elementary (7-10)',
      targetAgeMiddleSchool: 'Middle School (10-13)',
      targetAgeHighSchool: 'High School (13-16)',
      targetAgeSeniorHigh: 'Senior High (16-18)',
      targetAgeAdult: 'Adult (18+)',
