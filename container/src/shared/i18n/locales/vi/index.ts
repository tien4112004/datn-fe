export default {
  ...
  presentation: {
    createOutline: {
      ...
      languagePlaceholder: 'Ngôn ngữ nào?',
      ...
      targetAgePlaceholder: 'Cho độ tuổi nào?',
      targetAgeLabel: 'Độ tuổi',
      targetAgePreschool: 'Mầm non (3-5)',
      targetAgeEarlyElementary: 'Tiểu học đầu (5-7)',
      targetAgeElementary: 'Tiểu học (7-10)',
      targetAgeMiddleSchool: 'Trung học cơ sở (10-13)',
      targetAgeHighSchool: 'Trung học (13-16)',
      targetAgeSeniorHigh: 'Trung học phổ thông (16-18)',
      targetAgeAdult: 'Người lớn (18+)',
