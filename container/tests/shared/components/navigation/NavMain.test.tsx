...
vi.mock('@/shared/components/ui/sidebar', () => ({
  ...
  SidebarMenuSubButton: ({ children, ...props }: any) => <button data-testid="sidebar-menu-sub-button" {...props}>{children}</button>,
...
vi.mock('react-router-dom', () => ({
  NavLink: ({ to, children, ...props }: any) => <a href={to} data-testid="nav-link" {...props}>{children}</a>,
}))
...
describe('NavMain', () => {
  ...
  it('renders sub-items inside collapsible group', () => {
    ...
    const profileLink = screen.getAllByTestId('nav-link').find(a => a.getAttribute('href') === '/settings/profile')
    const accountLink = screen.getAllByTestId('nav-link').find(a => a.getAttribute('href') === '/settings/account')
