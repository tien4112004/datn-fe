...
export default {
  ...
  assignmentEditing: {
    ...
    multipleChoice: {
      ...
      alerts: { minOptions: 'Must have at least 2 options' },
      labels: {
        question: 'Question',
      ...
      buttons: { addOption: 'Add Option', removeImage: 'Remove image', addImage: 'Add image' },
    },
    matching: {
      title: 'Edit Matching Question',
      alerts: { minPairs: 'Must have at least 2 pairs' },
      labels: {
        question: 'Question',
        questionImage: 'Question Image (optional)',
        matchingPairs: 'Matching Pairs',
      ...
      buttons: { addPair: 'Add Pair', addImage: 'Add image', removeImage: 'Remove image' },
      pair: 'Pair {{number}}',
    },
    openEnded: {
    ...
    fillInBlank: {
      ...
      buttons: { addText: 'Add Text', addBlank: 'Add Blank', add: 'Add' },
      segmentTypes: { text: 'Text', blank: 'Blank' },
    },
  },
