import type { MatchingQuestion, MatchingPair } from '@aiprimary/core';
...
export const MatchingEditing = ({ question, onChange, validationErrors }: MatchingEditingProps) => {
  const { t } = useTranslation('questions', { keyPrefix: 'assignmentEditing.matching' });
  const { t: tEditing } = useTranslation('questions', { keyPrefix: 'assignmentEditing' });
