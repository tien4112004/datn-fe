...
// Add color to recently used list each time a non-preset color is selected
...
// Check if environment supports native eyedropper, use native if supported, otherwise use custom eyedropper
...
// Custom eyedropper based on Canvas
...
.picker-color-wrap {
  ...
  margin-top: 4px;
  margin-right: 4px;
  outline: 1px dashed rgb(from #666666 r g b / 0.12);
