<template>
  <div v-if="isGenerating" class="tw-fixed tw-inset-0 tw-z-[9999] tw-flex tw-items-center tw-justify-center tw-bg-gray-100/80 tw-backdrop-blur-[4px]">
    <div class="tw-flex tw-flex-col tw-items-center tw-justify-center tw-w-[200px] tw-h-[200px]">
      <div class="tw-w-9 tw-h-9 tw-border-4 tw-border-blue-600 tw-border-t-transparent tw-rounded-full tw-animate-spin"></div>
