...
export const SHAPE_PATH_FORMULAS: {
  ...
  [ShapePathFormulasKeys.L]: {
    ...
    formula: (width, height, values) => {
      ...
      return `M 0 0 L 0 ${height} L ${width} ${height} L ${width} ${height - lineWidth} L ${lineWidth} ${
        height - lineWidth
      } L ${lineWidth} 0 Z`;
    },
  },
  ...
  [ShapePathFormulasKeys.PLUS]: {
    ...
    formula: (width, height, values) => {
      ...
      } L 0 ${height / 2 - lineWidth / 2} L 0 ${height / 2 + lineWidth / 2} L ${width / 2 - lineWidth / 2} ${
        height / 2 + lineWidth / 2
      } L ${width / 2 - lineWidth / 2} ${height} L ${width / 2 + lineWidth / 2} ${height} L ${
        width / 2 + lineWidth / 2
      } ${height / 2 + lineWidth / 2} L ${width} ${height / 2 + lineWidth / 2} L ${width} ${
        height / 2 - lineWidth / 2
  ...
  [ShapePathFormulasKeys.INDICATOR]: {
    ...
    formula: (width, height, values) => {
      const point = width * values![0];
      return `M ${width} ${height / 2} L ${width - point} 0 L 0 0 L ${point} ${height / 2} L 0 ${height} L ${
        width - point
      } ${height} Z`;
    },
  },
...
export const getShapeList = (): ComputedRef<ShapeListItem[]> => {
  ...
  return computed(() => [
    ...
    {
      type: t('content.shapes.categories.common'),
      children: [
        {
          viewBox: [200, 200],
    ...
    {
      type: t('content.shapes.categories.arrow'),
      children: [
        {
          viewBox: [200, 200],
    ...
    {
      type: t('content.shapes.categories.other'),
      children: [
        {
          viewBox: [1024, 1024],
    ...
    {
      type: t('content.shapes.categories.series'),
      children: [
        {
          viewBox: [1024, 1024],
