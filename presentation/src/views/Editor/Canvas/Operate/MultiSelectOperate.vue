...
// Calculate the position information of the bounding box and scaling points based on the range of multiple selected elements on the canvas
...
// Calculate the range of multiple selected elements on the canvas
const setRange = () => {
...
// Disable scaling in multi-select state: only unrotated images and shapes can be scaled in multi-select state
