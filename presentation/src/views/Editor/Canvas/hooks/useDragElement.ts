...
export default (
  ...
  const dragElement = (e: MouseEvent | TouchEvent, element: PPTElement) => {
    ...
    // Collect alignment adsorption lines
    // Includes various alignment positions of other elements on the canvas except for the target element: top, bottom, left, right edges, horizontal center, vertical center
    // Lines and rotated elements need to recalculate their center point positions on the canvas
    // The four boundaries of the visible area of the canvas, horizontal center, vertical center
