...
export default (elementList: Ref<PPTElement[]>) => {
  ...
  // Drag the endpoints of the line
  const dragLineElement = (e: MouseEvent, element: PPTLineElement, command: OperateLineHandlers) => {
    ...
    // Get the 8 scaling points of all unrotated elements other than lines as adsorption positions
    ...
    document.onmousemove = (e) => {
      ...
      // Calculate the position of the line's start and end points in the editing area
      ...
      // Drag the position of the start or end point
      // Horizontal and vertical directions have adsorption
      ...
      // Calculate the updated coordinates of the start and end points based on the position of the element itself
