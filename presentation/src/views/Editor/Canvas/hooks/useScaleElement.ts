...
/**
 * Get the position of the opposite point relative to a certain scaling point of the element, such as: [Top] corresponds to [Bottom], [Top Left] corresponds to [Bottom Right]
