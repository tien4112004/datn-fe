...
export default (
  ...
  // If the target element is not currently selected, set it to the selected state
  // If the target element is already selected and Ctrl or Shift key is pressed, cancel its selected state
  // If the target element is already selected and is not the current operation element, set it as the current operation element
  // If the target element is already selected and is also the current operation element, clicking it again will set it as the active member in the multi-selected elements
