<template>
  <div class="base-view" :class="{ 'laser-pen': laserPen }">
    <ScreenSlideList
      ...
      @wheel="($event: any) => mousewheelListener($event)"
      @touchstart="($event: any) => touchStartListener($event)"
      @touchend="($event: any) => touchEndListener($event)"
    ...
    <div class="tools-left">
      <IconLeftTwo class="tool-btn big-icon" theme="two-tone" @click="execPrev()" />
      <IconRightTwo class="tool-btn big-icon" theme="two-tone" @click="execNext()" />
    </div>
    ...
    >
      <div class="content">
        ...
        <IconPower
          class="tool-btn"
          v-tooltip="t('presentation.controls.endPresentation')"
          @click="exitScreening()"
        />
      </div>
    </div>
...
const contextmenus = (): ContextmenuItem[] => {
  return [
    ...
    { divider: true },
    {
      text: autoPlayTimer.value
        ? t('presentation.controls.playback.cancelAutoPlay')
        : t('presentation.controls.playback.autoPlay'),
